module.exports = {
  siteMetadata: {
    ...
    author: {
      name: `Cyscale`,
      summary: `Next-generation security, compliance & governance tools to continuously identify vulnerabilities and protect cloud environments with automatic remediations.`,
    },
  ...
  plugins: [
    ...
    `gatsby-plugin-feed`,
    {
      ...
      options: {
        name: `Cyscale Power Cloud Platform`,
        short_name: `Cyscale`,
        start_url: `/`,
        background_color: `#ffffff`,
        theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `content/assets/cyscale-icon.png`,
      },
    },
