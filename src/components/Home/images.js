    ...
    return (props) => {
        const data = useStaticQuery(graphql`
            query ImagesQuery {
                ...
                cisBenchmarksCloudComplianceSmall: file(relativePath: { eq: "cis-benchmarks-cloud-compliance.png" }) {
                    childImageSharp {
                        gatsbyImageData(height: 45, layout: CONSTRAINED)
                    }
                }
                ...
                oracle: file(relativePath: { eq: "integration-oracle-cloud-infrastructure-oci-security-logo.png" }) {
                    childImageSharp {
                        gatsbyImageData(width: 100, layout: CONSTRAINED)
                    }
                }
                ...
                jumpcloud: file(
                    relativePath: { eq: "integration-jumpcloud-cloud-identity-provider-security-logo.png" }
                ) {
                    childImageSharp {
                        gatsbyImageData(width: 100, layout: CONSTRAINED)
                    }
                ...
                gsuite: file(
                    relativePath: { eq: "integration-g-suite-google-workspaces-cloud-identity-security-logo.png" }
                ) {
                    childImageSharp {
                        gatsbyImageData(width: 100, layout: CONSTRAINED)
                    }
        ...
        `);
        return <WrappedComponent {...props} imageData={data} />;
    };
}

export const SecurityKnowledgeGraph = withImageData((props) => (
    <Img
        image={props.imageData.cyscaleSecurityKnowledgeGraph.childImageSharp.gatsbyImageData}
        alt='Security Knowledge Graph™'
    />
));
...
export const ISO27001 = withImageData((props) => (
    <Img
        image={props.imageData.iso27001ComplianceAudit.childImageSharp.gatsbyImageData}
        alt='ISO 27001 Compliance Audit'
    />
));
export const AicpaSoc2 = withImageData((props) => (
    <Img
        image={props.imageData.aicpaSoc2ComplianceAudit.childImageSharp.gatsbyImageData}
...
export const EuEuropeanGdpr = withImageData((props) => (
    <Img
        image={props.imageData.euEuropeanGdprCompliance.childImageSharp.gatsbyImageData}
...
export const ISO27001Small = withImageData((props) => (
    <Img
        image={props.imageData.iso27001ComplianceAuditSmall.childImageSharp.gatsbyImageData}
        alt='ISO 27001 Compliance Audit'
    />
));
...
export const Docker = withImageData((props) => (
    <Img image={props.imageData.docker.childImageSharp.gatsbyImageData} alt='Integration Docker Container' />
));
...
export const Aws = withImageData((props) => (
    <Img image={props.imageData.aws.childImageSharp.gatsbyImageData} alt='Amazon Web Services (AWS)' />
));
export const Github = withImageData((props) => (
    <Img image={props.imageData.github.childImageSharp.gatsbyImageData} alt='Github Source Code' />
));
export const Gitlab = withImageData((props) => (
    <Img image={props.imageData.gitlab.childImageSharp.gatsbyImageData} alt='Gitlab Source Code' />
));
export const Kubernetes = withImageData((props) => (
    <Img image={props.imageData.kubernetes.childImageSharp.gatsbyImageData} alt='Kubernetes Cluster (k8s)' />
));
export const Azure = withImageData((props) => (
    <Img image={props.imageData.azure.childImageSharp.gatsbyImageData} alt='Microsoft Azure Cloud' />
));
export const Gcp = withImageData((props) => (
    <Img image={props.imageData.gcp.childImageSharp.gatsbyImageData} alt='Google Cloud Platform (GCP)' />
));
export const Alibaba = withImageData((props) => (
    <Img image={props.imageData.alibaba.childImageSharp.gatsbyImageData} alt='Alibaba Aliyun' />
));
export const Slack = withImageData((props) => (
    <Img image={props.imageData.slack.childImageSharp.gatsbyImageData} alt='Notifications and Collaboration Slack' />
));
export const Jamf = withImageData((props) => (
    <Img image={props.imageData.jamf.childImageSharp.gatsbyImageData} alt='Jamf Enterprise Endpoint Management' />
));
export const Snowflake = withImageData((props) => (
    <Img image={props.imageData.snowflake.childImageSharp.gatsbyImageData} alt='Snowflake Cloud Data Security' />
));
export const Veracode = withImageData((props) => (
    <Img image={props.imageData.veracode.childImageSharp.gatsbyImageData} alt='Veracode Appsec Vulnerability' />
));
export const Jira = withImageData((props) => (
    <Img image={props.imageData.jira.childImageSharp.gatsbyImageData} alt='Jira Confluence Atlassian Remote Work' />
));
...
export const Jumpcloud = withImageData((props) => (
    <Img image={props.imageData.jumpcloud.childImageSharp.gatsbyImageData} alt='Jumpcloud Identity Provider' />
));
export const Tenable = withImageData((props) => (
    <Img image={props.imageData.tenable.childImageSharp.gatsbyImageData} alt='Tenable Vulnerability Management' />
));
export const Okta = withImageData((props) => (
    <Img image={props.imageData.okta.childImageSharp.gatsbyImageData} alt='Okta Cloud Identity' />
));
export const Vmware = withImageData((props) => (
    <Img image={props.imageData.vmware.childImageSharp.gatsbyImageData} alt='Vmware' />
));
export const Gsuite = withImageData((props) => (
    <Img image={props.imageData.gsuite.childImageSharp.gatsbyImageData} alt='Google Workspaces' />
));
