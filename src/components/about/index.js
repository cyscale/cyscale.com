      ...
      <div>
        ...
        >
          ...
          <Hero
            ...
            pageName= {pageName}
          />
          <div className="w-full text-center hidden sm:inline-block">
            <a href="#start" className="no-underline block w-24px m-auto">
              <img src={downDoubleArrow} className="w-24px" alt="" />
            </a>
          </div>
        </div>
        <div id="start">
