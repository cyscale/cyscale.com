                                        ...
                                        <th className="bg-white  xl:w-1/4">
                                            <div className="pr-22px pl-17px pt-24px pb-24px">
                                                <div className="flex flex-col">
                                                        ...
                                                        <Link to="https://app.cyscale.com" className="blackBorder w-full block mt-75px text-15px font-normal rounded text-black uppercase text-center pt-18px pb-18px pl-49px pr-49px no-underline transition-all duration-300 hover:border-black hover:bg-black hover:text-white blackBorder">GET IT FREE</Link>
                                        ...
                                        <th className="bg-white businessCol xl:w-1/4 shadow-lg drop-shadow-lg">
                                            <div className="pr-22px pl-17px pt-24px pb-24px innerShadow">
                                                <div className="flex flex-col">
                                                        ...
                                                        <Link to="https://app.cyscale.com" className="gradientBgBtn w-full block mt-75px text-15px font-normal rounded text-white uppercase text-center pt-19px pb-19px pl-49px pr-49px no-underline">START FREE TRIAL</Link>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="text-center text-15px text-black font-normal pt-16px pb-16px pl-24px pr-24px">
                                            <img src={Check} className="w-22px mx-auto" alt="" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center text-15px text-black font-normal pt-16px pb-16px pl-24px pr-24px">
                                            <img src={Line} className="w-22px mx-auto" alt="" />
                                        </td>
                                        <td className="shadow-lg drop-shadow-lg text-center text-15px text-black font-normal pt-16px pb-16px pl-24px pr-24px">
                                            <img src={Check} className="w-22px mx-auto" alt="" />
                                        </td>
