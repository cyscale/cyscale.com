        ...
        <>
            <div>
                <div className="relative lg:absolute xl:absolute 2xl:absolute  top-50 left-51 mb-30px">
                    <h2 className="text-12px">01.02.2021</h2>
                    <h2 className="text-12px">by: Prenume Nume</h2>
                </div>
                <div className="max-w-588px m-auto relative ">
                    <h3 className="text-16px leading-24px">I</h3>
                    <h3 className="text-16px leading-24px">
                        Lorem ipsum dolor sit amet, consectetuer adipiscing elit,
                        sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
                    </h3>
                    <p className="pt-15px text-16px leading-24px">
                    ...
                    <h6 className="text-blue text-14px underline text-blue-600 pt-8px">EXPLORE COMPLIANCE FEATURES</h6>
                    <br /><br /><br />
                    <h3 className="text-16px leading-24px">II</h3>
                    <h3 className="text-16px leading-24px">
                        Lorem ipsum dolor sit amet, consectetuer adipiscing elit,
                        sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
                    </h3>
                    ...
                    <h6 className="text-blue text-14px underline text-blue-600 pt-8px">EXPLORE COMPLIANCE FEATURES</h6>
                    <br /><br /><br />
                    <h3 className="text-16px leading-24px">III</h3>
                    <h3 className="text-16px leading-24px">
                        Lorem ipsum dolor sit amet, consectetuer adipiscing elit,
                        sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
                    </h3>
                    <p className="pt-15px text-16px leading-24px">
                        ...
                        dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto
                        odio dignissim qui blandit praesent luptatum zzril delenit augue duis
                        dolore te feugait nulla facilisi.consequat, vel illum
                        dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto
                        odio dignissim qui blandit praesent luptatum zzril delenit augue duis
                        dolore te feugait nulla facilisi.
                    </p><br />
                    <img className="w-588px h-392px sm:w-100%" src={image} alt="img" /><br />
                    <p className="pt-15px text-16px leading-24px">
                        Lorem ipsum dolor sit amet, consectetuer adipiscing elit,
                        sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
                        Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper
