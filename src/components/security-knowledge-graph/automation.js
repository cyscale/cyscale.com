                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 border-b border-lightGrey border-solid pb-88px'>
                            <div>
                                <p className='text-16px text-black new-line'>
                                    ...
                                    <br />
                                    <br />
                                    Cybersecurity tools are often designed for specific issues. So assembling and
                                    managing each one creates a lot of overhead and drains your time, energy, and
                                    budget. We've been there too.
                                    <br />
                                    <br />
                                    ...
                                    , we create a micrograph for every cloud system you have. We then connect these
                                    micrographs to generate your own Security Knowledge Graph™. That's how the
                                    <br />
                                    <Link
                                    ...
                                    &nbsp;gives you a truly contextual understanding of your digital assets.
                                </p>
                            </div>
                                        ...
                                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                                            <div>
                                                <img
                                                    ...
                                                    src={icon1}
                                                    className='h-45px'
                                                    alt='Bring all your cloud data under one roof'
                                                />
                                            ...
                                            <div>
                                                <img
                                                    ...
                                                    src={icon2}
                                                    className='h-45px'
                                                    alt='Identify and track all your cloud entities'
                                                />
                                                <p className='text-16px text-black font-bold mt-22px'>
                                            ...
                                            <div>
                                                <img
                                                    ...
                                                    src={icon3}
                                                    className='h-45px'
                                                    alt='Remove the limitations of list-based inventories'
                                                />
                                                <p className='text-16px text-black font-bold mt-22px'>
                                            ...
                                            <div>
                                                <img
                                                    ...
                                                    src={icon4}
                                                    className='h-45px'
                                                    alt='Create rich security profiles for each asset'
                                                />
                                                <p className='text-16px text-black font-bold mt-22px'>
                                    ...
                                    <div className='pt-45px pb-45px'>
                                        <div className='flex flex-wrap flex-grow h-full justify-center xl:justify-start'>
                                            <img
                                                ...
                                                src={feauterImage}
                                                className='w-48'
                                                alt='Valuable insights for peace of mind.'
                                            />
