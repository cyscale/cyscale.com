                ...
                <div className='block w-full'>
                    <div className='max-w-1366px mx-auto pl-20px pr-20px md:pl-40px md:pr-40px lg:pl-60px lg:pr-60px xl:pl-80px xl:pr-80px 2xl:pl-80px 2xl:pr-80px'>
                        <div className='grid grid-cols-1'>
                            <h2 className='font-semibold  text-blue w-full text-24px sm:text-34px leading-normal lg:max-w-sm sectionTitle font-montserrat'>
                                FAQs
                            </h2>
                        </div>
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
                            ...
                            <div>
                                {dataFAQs(true).map((content, index) => (
                                    <div key={index} className='mb-5'>
                                        <button
                                            ...
                                            className={`block w-full text-left pr-20px text-16px text-black font-bold leading-normal cursor-pointer relative tabTitle border-none outline-none ${
                                                index === 0 && tabActive === 0 && 'active'
                                        ...
                                        <p
                                            className={`text-16px text-black leading-normal mt-40px new-line ${
                                                index === 0 && tabActive === 0 ? 'block' : ''
                                            } ${index === tabActive ? 'block' : 'hidden'}`}
                                        >
                                            {content.answer}
                                        </p>
                                    </div>
