  ...
  return (
    <Root>
      <Container>
        <Row>
          <Col>
            <H1>Built to protect the Cloud</H1>
            <Description>
              Next-generation security, compliance & governance tools to
              continuously identify vulnerabilities and protect cloud
              environments with automatic remediations.
            </Description>
            <Anchor
              contained
              target="_blank"
          ...
          <Col>
            <Mockup fluid={hero.childImageSharp.fluid} />
          </Col>
        </Row>
      </Container>
      <Scroll href="#">
