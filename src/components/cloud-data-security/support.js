    ...
    return (
        <div className='pt-65px pb-65px'>
            <div className='max-w-1366px mx-auto pt-50px pl-20px pr-20px md:pl-40px md:pr-40px lg:pl-60px lg:pr-60px xl:pl-80px xl:pr-80px 2xl:pl-80px 2xl:pr-80px'>
                {!!title && (
                    <h2 className='font-semibold  text-blue font-proximaBold text-34px mb-69px font-montserrat'>
                        {title}
                    </h2>
                )}
                <div
                    className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pb-50px border-b ${
                        !!sectionName && sectionName === 'supportSection' ? 'border-white' : 'border-borderGrey'
                    } border-solid`}
                >
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-4'>
                                    ...
                                    <div className='col-span-3 md:pl-128px lg:pl-100px'>
                                        <p className='new-line text-16px text-black leading-normal'>
                                            ...
                                            obligations with the 500+ ready-to-use security controls and policies you
                                            can apply and monitor through automatic, ongoing checks for
                                            misconfigurations. Get alerts whenever your most valuable cloud assets drift
                                            from your initial configuration. We help you meet compliance requirements
                                            for GDPR, HIPAA, NIST, PCI-DSS, and many others.
                                            <br />
                                            <br />
                                            From data encryption and key management to firewalls, whether it’s in the
                                            public cloud, multi-cloud, or hybrid cloud, we help you take the right
                                            decisions and take appropriate security measures to keep your data safe.
                                        </p>
                                    </div>
                                </div>
                            </div>
