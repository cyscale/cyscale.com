                ...
                <div className='grid grid-cols-1 md:grid-col-2 lg:grid-cols-3 gap-6 pb-80px border-b border-solid border-borderGrey'>
                    <div>
                        <p className='new-line text-black text-16px leading-normal'>
                            ...
                            makes it easy to see who has access to individual assets and how they interact with one
                            another. A structure of micrographs represents these complex relationships in a visual,
                            intuitive format anyone can navigate with zero training.
                            <br />
                            <br />
                            No more shadow access, excessive permissions and other cybersecurity issues cross-cloud
                            interactions create. Know who's accessing your sensitive data and what they're doing with
                            it.
                        </p>
                        <p className='new-line text-black text-base mt-4 leading-normal'>
                            With Cyscale, you understand how to implement strong IAM (Identity and Access Management)
                            policies to keep security threats away using access control and authentication rules.{' '}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className='new-line text-black text-16px leading-normal'>
                            ...
                            standard that helps security, IT, and compliance specialists ensure critical data is safe
                            against unauthorized exposure, data breaches, malware, and accidental or malicious misuse.
                        </p>
                    </div>
                </div>
            </div>
