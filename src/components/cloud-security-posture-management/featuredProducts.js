                    ...
                    <TabPanel key={index}>
                        ...
                        <div className="featureSlider justify-evenly flex items-center">
                            <div className="flex-initial">
                                <button type="button" aria-label="left" className="outline-none focus:outline-none" tabIndex={index} onKeyDown = {shiftTabPrev} onClick = {shiftTabPrev}><img src={left} className="m-auto cursor-pointer" alt="" /></button>
                            </div>
                            <div className="flex-initial">
                                <div className="max-w-5xl m-auto">                                    
                                     <img src={content.featureImage} className="m-auto" alt="" />
                                </div>
                            </div>
                            <div className="flex-initial">
                                <button type="button" aria-label="right" className="outline-none focus:outline-none" tabIndex={index} onKeyDown = {shiftTabNext} onClick = {shiftTabNext}><img src={right} className="m-auto cursor-pointer" alt="" /></button>
                            </div>
                        </div>
                        </div>
                    </TabPanel>
