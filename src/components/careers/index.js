    ...
    return (
        <>
            <div className={`w-full careers bg-lightGreyEEE bg-contain bg-no-repeat relative`}>
                <img src={BannerImage} className='absolute top-153px right-0 w-full h-auto bannerImage' alt='' />
                ...
                <div className='block w-full bannerBG pt-120px'>
                    <div className='max-w-1366px mx-auto pl-20px pr-20px md:pl-40px md:pr-40px lg:pl-60px lg:pr-60px xl:pl-80px xl:pr-80px 2xl:pl-80px 2xl:pr-80px'>
                        <h1 className='text-30px pt-390px md:text-30px xl:text-60px xl:w-96 new-line text-blue font-proximaBold'>
                            Join the Cyscale Team
                        </h1>
                    </div>
                    <div className='max-w-1366px mx-auto mt-48 pt-195px pb-104px pl-20px pr-20px md:pl-40px md:pr-40px lg:pl-60px lg:pr-60px xl:pl-80px xl:pr-80px 2xl:pl-80px 2xl:pr-80px'>
                        <Sectionheader headingText={`Together, we can make the world a safer place!`} />
                    </div>
