                        ...
                        <div className="mt-24px w-full sm:w-auto">
                          {pageName === "ComplianceAuditing" && (
                            <div className="flex flex-row mb-4 items-center justify-between lg:hidden flex-wrap space-y-4 lg:space-y-0 lg:space-x-2">
                              <img src={icon1} className="h-38px mt-20px" alt="" />
                              <img src={icon2} className="h-38px" alt="" />
                              <img src={icon3} className="h-38px" alt="" />
                              <img src={icon4} className="h-38px" alt="" />
                              <img src={icon6} className="h-38px" alt="" />
                              <img src={icon8} className="h-38px" alt="" />
                            </div>
                          )}
                          <a
                            href={bannerBtn1Link}
                ...
                {pageName === "ComplianceAuditing" && (
                  <div className={`lg:pt-14`}>
                    ...
                    <div className="hidden lg:flex flex-row items-center justify-between mt-28 flex-wrap space-y-4 lg:space-y-0 lg:space-x-2">
                      <img src={icon1} className="h-58px" alt="" />
                      <img src={icon2} className="h-58px" alt="" />
                      <img src={icon3} className="h-58px" alt="" />
                      <img src={icon4} className="h-58px" alt="" />
                      <img src={icon6} className="h-58px" alt="" />
                      <img src={icon8} className="h-58px" alt="" />
                    </div>
                  </div>
                )}
              </div>
