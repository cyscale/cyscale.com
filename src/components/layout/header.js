...
const Header = ({
  ...
  const rootClasses = `
    ...
    ${
      pageName === "SKGPage" || pageName === "jobDetails"
        ? "bg-lightGreyEEE"
        : "bg-cover"
    }`;
                ...
                <p className="text-black text-16px new-line hidden sm:block">
                  {pageName === "SKGPage" ? (
                    <span>
                      ...
                      aggregation. But even when they deliver, it’s not enough
                      to make your job easier.
                      <br />
                      <br />
                      That’s why we built the Security Knowledge Graph™. Because
                      you deserve a cloud security platform that surfaces
                      crucial issues based on deep understanding of all your
                      interlinked assets.
                      <br />
                      <br />
