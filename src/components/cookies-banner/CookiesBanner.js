                ...
                <div className='visible h-96 sm:h-56 md:h-44 lg:h-36'>
                    <div className='grid grid-rows-12 h-full'>
                        <div
                            ...
                            <div>
                                <p className='text-black'>This website <strong>stores cookies on your computer</strong>.
                                    These cookies are used to collect information about how you interact with our
                                    website and allow us to remember you. We use this information <strong>in order to
                                        improve and customize your browsing experience</strong> and for <strong>analytics
                                        and metrics about our visitors</strong> both on this website and other media.
                                </p>
                                <p className='text-black mt-4'> To find out more about the cookies we use, see our
                        ...
                        <div
                            ...
                            <p className='text-primary md:mb-2 lg:mb-0 cursor-pointer' tabIndex='0'
                               onClick={() => setCookiesModal(!cookiesModal)} onKeyUp={openModalOnKeyUp}><strong>Cookies
                                Settings</strong></p>
                            <button
                                className='inline-block font-medium rounded bg-red text-white text-center py-3 px-6 ml-4'
                                onClick={() => setCookiesBanner(!cookiesBanner)}
                            >
                                Accept All Cookies
                            </button>
                        </div>
