                        ...
                        <div className='col-span-12 md:col-start-1 md:col-end-6 lg:max-w-2xl xl:max-w-4xl 2xl:max-w-7xl flex items-center px-3'>
                            <div>
                                <p className='text-black hidden sm:block'>
                                    ...
                                    used to collect information about how you interact with our website and allow us to
                                    remember you. We use this information{' '}
                                    <strong>in order to improve and customize your browsing experience</strong> and for{' '}
                                    <strong>analytics and metrics about our visitors</strong> both on this website and
                                    other media.
                                </p>
