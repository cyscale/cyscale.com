                ...
                <div className='max-w-1366px mx-auto mt-88px pl-20px pr-20px md:pl-40px md:pr-40px lg:pl-60px lg:pr-60px xl:pl-80px xl:pr-80px 2xl:pl-80px 2xl:pr-80px'>
                    <div className='flex'>
                        <div className='mx-auto w-full xl:w-2/4 text-16px font-bold tetx-black leading-normal'>
                            ...
                            <p className='mb-36px'>
                                All <strong> Cyscale</strong> Platform data is hosted on Google Cloud Platform (GCP). We
                                take advantage of all the security and privacy features GCP provides, plus our team
                                takes additional pro-active measures to maintain a secure infrastructure and make sure
                                there are always multiple backups for infrastructure disaster recovery purposes (though
                                we can't offer backup in case of user made errors on a per account basis). For more
                                specific details regarding how GCP keeps data secure, please refer to{' '}
                                <a
                            ...
                            <p className='mb-36px'>
                                GCP maintains an impressive list of reports, certifications, and independent assessments
                                to ensure complete and ongoing state-of-the-art data center security. They have many
                                years of experience in designing, constructing, and operating large-scale data centers,
                                which makes them the industry standard when it comes to security. The exact physical
                                location of the data center that stores <strong> Cyscale</strong> Platform's data is
                                private. Only those within Google who have a legitimate business know the actual
                                location of Google's data centers. Additionally, data centers are secured with a variety
                                of physical controls to prevent unauthorized access.
                            </p>
                            <h2 className='font-semibold mb-36px text-24px'>Infrastructure Security</h2>
                            <p className='mb-36px'>
                                All <strong> Cyscale</strong> Platform servers are run from own virtual private clouds
                                (VPCs), with rules that prevent unauthorized requests from entering our network.{' '}
                                <strong> Cyscale</strong> Platform infrastructure is hosted in a fully redundant, secure
                                VPN environment, with access restricted to operations support staff only. This way we
                                can leverage complete firewall protection, private IP addresses, and other security
                                features. The whole system on which <strong> Cyscale</strong> Platform runs is behind a
                                firewall and only the necessary ports are open to the outside network. Also, only
                                authorized personnel, using SSH keys, have access to the system. Access is enabled only
                                over a VPN connection.
                            </p>
                            <h2 className='font-semibold mb-36px text-24px'>Application Security</h2>
                            <p className='mb-36px'>
                                All data to and from <strong> Cyscale</strong> Platform is sent securely over HTTPS. The
                                ...
                                <strong> Cyscale</strong> Platform is kept separate through a logical separation at the
                                data tier, based on application-level access permissions and roles you set up in your
                                workspaces. Passwords are encrypted so the database doesn't store actual values. Other
                            ...
                            <p className='mb-36px'>
                                ...
                                Delivery and Deployment (CI/CD) best practices, we can update <strong> Cyscale</strong>{' '}
                                Platform on a daily basis and fix things as soon as we see them. We never access your
