...
const q2 = [
    {
        ...
        answer: (
            <>
                <p className='mb-4'>
                    You can submit your application directly on our webpage.
                </p>
    ...
    },
    {
        ...
        answer: (
            ...
            <p className='mb-4'>
                The <Link className='underline' to='/security-for-startups-program'>
                Cyscale for Startups </Link>
                Program contract has an annual duration. (6 months free + 6 months at a
                discounted price)
            </p>
    ...
    },
    {
        ...
        answer: (
            ...
            <p className='mb-4'>
                Yes, you can. You need to contact our team about this.
            </p>
                            ...
                            <div className='col-span-12 lg:col-span-6 '>
                                <div className='lg:mt-16 pt-4 max-w-lg mx-auto lg:mx-0'>
                                    ...
                                    <p className='text-center sm:text-left text-base lg:text-lg mb-8 leading-relaxed text-gray'>
                                        ...
                                        purpose is to raise awareness about the importance of security and compliance in
                                        the cloud.
                                    </p>
                                    <p className='text-center sm:text-left text-base lg:text-lg mb-2 leading-relaxed text-gray'>
                                        Let us help you grow and enjoy success with a well-implemented security posture!
                                    </p>
                                </div>
                            </div>
                ...
                <div className='py-12 md:py-24'>
                    ...
                    <div className='grid grid-cols-12 gap-x-5'>
                        <div className='col-span-12 lg:col-span-6 lg:mx-0'>
                            <div
                                className='mt-6 lg:mt-0 rounded-xl  max-w-lg lg:max-w-2xl mx-auto relative gradientBG h-64 flex flex-col justify-center items-center'>
                                <h1 className='text-white text-3xl sm:text-4xl mb-6 font-semibold'>Up to $2M in
                                    funding</h1>
                                ...
                                <p className='text-white text-xl sm:text-2xl font-semibold'>75% off for the next 6
                                    months</p>
                            </div>
                        </div>
                        <div className='col-span-12 lg:col-span-6 lg:mx-0'>
            ...
            <Container>
                <div className='pt-2 pb-0 sm:pb-24'>
                    ...
                    <div className='grid grid-cols-12 gap-x-5'>
                        <div className='col-span-12 lg:col-span-6'>
                            <div
                                ...
                                <h1 className='text-2xl font-medium'>Access the entire Cyscale Cloud Platform
                                    with <br /> Powerful Analytics & Dashboards</h1>
                                <p className='text-xl mt-4'>Up to 1000 protected assets.</p>
                                <GatsbyImage image={data.dashboard.childImageSharp.gatsbyImageData} alt='Dashboard' />
                            </div>
                        </div>
                        ...
                        <div className='col-span-12 lg:col-span-3'>
                            <div
                                ...
                                <GatsbyImage image={data.cardIntegrations.childImageSharp.gatsbyImageData}
                                             alt='Integrations' className='mt-8 lg:mt-16' />
                            </div>
                        </div>
                    </div>
                    <div className='grid grid-cols-12 gap-x-5 mt-24'>
                        <div className='col-span-12 lg:col-span-3'>
                            <div
                                className='mt-6 lg:mt-0 rounded-xl pt-8 pb-60 sm:pb-0 px-8 max-w-lg lg:max-w-2xl mx-auto lg:mr-0 lg:ml-auto relative h-64 bg-black h-misconfiguration'>
                                <h1 className='text-2xl text-white font-medium'>Misconfiguration detection</h1>
                                <GatsbyImage image={data.cardMisconfiguration.childImageSharp.gatsbyImageData}
                                             alt='Misconfiguration' className='mt-2' />
                            </div>
                        </div>
                        <div className='col-span-12 lg:col-span-3'>
                            <div
                                className='mt-6 lg:mt-0 rounded-xl pt-8 px-8 max-w-lg lg:max-w-2xl mx-auto lg:mr-0 lg:ml-auto relative h-64'
                                style={{ backgroundImage: 'linear-gradient(to bottom, #e7474b, #ee3d53, #f3305b, #f92065, #fd0070)' }}>
                                <h1 className='text-2xl text-white font-medium'>Alerts and remediation instructions</h1>
                        ...
                        <div className='col-span-12 lg:col-span-6'>
                            <div
                                ...
                                style={{ backgroundImage: 'linear-gradient(to bottom, #4a85eb, #326fe3, #1b58d8, #073fcc, #0623be)' }}>
                                <h1 className='text-2xl text-white font-medium px-8'>Built-in frameworks for
                                    ISO27001, <br /> PCI-DSS, SOC2, GDPR, and others</h1>
                                <GatsbyImage image={data.cardStandards.childImageSharp.gatsbyImageData}
                                             alt='Standards' />
                            </div>
                        </div>
                    </div>
