                        ...
                        <Row>
                            <div className='col-span-12 lg:col-span-6 '>
                                <div className='mt-16 pt-12 lg:pt-24 max-w-lg mx-auto lg:mx-0 bg-pricing'>
                                    ...
                                    <p className='text-lg lg:text-2xl mb-12'>We are happy to schedule a product demo with you. Just fill out the form <span className='inline lg:hidden'>below</span> and we will be in touch shortly.</p>
                                </div>
                            </div>
                            <div className='col-span-12 lg:col-span-6 '>
                                <div className='lg:bg-white rounded-lg mt-6 lg:mt-0 lg:rounded-xl lg:shadow-lg  lg:pt-12 pb-0 px-0 lg:px-12 max-w-lg mx-auto lg:mr-0 lg:ml-auto relative'>
                                    ...
                                    <div style={{ minHeight: 465 }} id='demo-form' />
                                </div>
                            </div>
                        </Row>
                    </Section>
