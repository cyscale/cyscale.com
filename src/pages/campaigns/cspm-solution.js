                            ...
                            <div className='col-span-12 lg:col-span-5 text-white'>
                                <div className='max-w-lg mx-auto lg:ml-0 lg:mr-auto'>
                                    ...
                                    <ul className='list-disc pl-4 ml-4'>
                                        <li className='mb-2'>A comprehensive Asset Inventory and Asset Management</li>
                                        <li className='mb-2'>
            ...
            <div className='bg-gradient-footer pt-60px pb-60px'>
                <Container>
                    <div className='mx-auto max-w-md text-center py-20'>
                        ...
                        <h3 className='font-semibold  text-white text-xl uppercase '>
                            AGENTLESS, MULTI-CLOUD, PAINLESS CSPM
                        </h3>
                        <p className='text-white text-base mt-1 mb-12'>Start seeing value & saving money in minutes</p>
                        <ScrollLink
