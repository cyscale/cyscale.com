...
import ThankYouFreeTrial from '../components/thank-you/ThankYouFreeTrial';
...
const FreeTrial = ({ location }) => {
    ...
    return (
        <AnimatedNavbarLayout
            location={location}
            pageName='FreeTrial'
            title='Start Your Free Trial | Cyscale Cloud Security'
            description='Secure your cloud quickly and easily with cloud security designed for SaaS builders and small businesses'
        >
            ...
            <div className='hidden' data-description>
                Secure your cloud quickly and easily with cloud security designed for SaaS builders and small businesses
            </div>
            ...
            {!formSubmitted ? (
                                    ...
                                    <div className='col-span-12 lg:col-span-6 '>
                                        <div className='max-w-lg lg:max-w-xl mx-auto lg:mx-0'>
                                            ...
                                            <p className='text-lg text-left text-base font-medium max-w-md lg:max-w-xl mt-8 font-montserrat'>
                                                If you’re a fast-growing SaaS company or a small organization with data
                                                in the cloud, security shouldn’t hold you back. The Cyscale platform
                                                automates security for your apps and data in the cloud without the need
                                                for a big security team or a big budget.
                                            </p>
                            ...
                            <div className='grid grid-cols-12 gap-x-5'>
                                ...
                                <div className='col-span-12 lg:col-span-3'>
                                    ...
                                    >
                                        ...
                                        <p className='text-lg font-hind mt-4 text-center'>
                                ...
                                <div className='col-span-12 lg:col-span-3'>
                                    ...
                                    >
                                        ...
                                        <p className='text-lg font-hind mt-4'>
                                ...
                                <div className='col-span-12 lg:col-span-3'>
                                    ...
                                    >
                                        ...
                                        <p className='text-lg text-white font-hind mt-1'>
                                            of your cloud environments to identify cloud misconfiguration
                                            vulnerabilities
                                        </p>
                                        <GatsbyImage
                                ...
                                <div className='col-span-12 lg:col-span-6'>
                                    ...
                                    >
                                        <h2
                                            ...
                                            `}
                                        >
                                            Built-in frameworks for CIS Cloud Benchmarks, ISO 27001, SOC 2, GDPR, HIPAA,
                                            PCI DSS, NIST, and many more
                                        </h2>
                                    ...
                                    <div className='col-span-12 lg:col-span-6'>
                                        ...
                                        >
                                            <h3
                                                ...
                                                `}
                                            >
                                                Cyscale is an Automated Cloud Security platform designed for
                                            ...
                                            <p className='font-hind text-lg mt-4'>
                                                ...
                                                shouldn’t hold you back. Good security should enable growth through
                                    ...
                                    <div className='col-span-12 lg:col-span-3'>
                                        ...
                                        >
                                            <p className='font-hind text-lg'>
                                                Don’t get overwhelmed with alerts and complex toolkits. Cyscale
                                                continuously monitors for vulnerabilities and misconfigurations in your
                                                cloud environment, then guides you through the actions you need to take
                                                to fix them.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className='grid grid-cols-12 gap-x-5 mt-4'>
                                    <div className='col-span-12 lg:col-span-6 mx-auto lg:mx-0 lg:mt-0 max-w-lg lg:max-w-full'>
                                        ...
                                        >
                                            ...
                                            environment is secure. The team had an aim of ‘zero alerts’, which meant
                                            ensuring the cloud environment was always in compliance with their policies.
                                        </p>
                                        <img src={QuotesStartups} alt='' className='mt-4' />
                                        <p className='mt-4 text-base font-semibold font-hind'>
                                            Cyscale is eliminating the need to ask the team for tedious configuration
                                            reports, greatly improving our visibility and helping us understand things
                                            we didn’t know.
                                        </p>
                                    ...
                                    <div className='col-span-12 lg:col-span-6 mx-auto lg:mx-0 mt-20 lg:mt-0 max-w-lg lg:max-w-full'>
                                        ...
                                        <p
                                            ...
                                            `}
                                        >
                                            Bays Consulting is a data analytics and consulting company who uses AWS to
                                            deliver innovative data solutions and insights to businesses. Securing
                                            client data and automating their ISO 27001 compliance is at the core of
                                            their business. Cyscale helped Bays Consulting address their challenges and
                                            streamlined the access review process.
                                        </p>
                                        <img src={QuotesStartups} alt='' className='mt-4' />
                                        <p className='mt-4 text-base font-semibold font-hind'>
                                            Exceptionally helpful when doing access reviews; I’m using the platform
                                            monthly and it simply automates my work!
                                        </p>
                                        <p className='font-hind text-base mt-2'>
                ...
                <ThankYouFreeTrial email={playgroundEmail} />
            )}
        </AnimatedNavbarLayout>
    );
};
